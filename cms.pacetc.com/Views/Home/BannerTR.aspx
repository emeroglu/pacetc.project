...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadCPH" runat="server">
    <script type="text/javascript">
        ...
        function BannerCtrl($scope, $http) {
            ...
            $http({ method: "GET", url: "/AllBannersTR" }).success(function (data) {
            ...
            $scope.save = function () {
                ...
                $http({ method: "POST", url: "/SaveBannerTR", data: $scope.banner }).success(function (data) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyCPH" runat="server">
    <div ng-controller="BannerCtrl">
        <div style="width: 750px; height: 50px;">
            ...
            <a href="http://tr.pacetc.com/BannerPreview" target="_blank">
